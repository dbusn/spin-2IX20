...
#define _nstates1	5	/* :init: */
#define minseq1	2
#define maxseq1	5
#define _endstate1	4

#define _nstates0	3	/* Hello */
#define minseq0	0
#define maxseq0	1
#define _endstate0	2
...
#define Air1	(sizeof(P1) - Offsetof(P1, lastpid) - 1*sizeof(int))

#define PHello	((P0 *)_this)
typedef struct P0 { /* Hello */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 4; /* state    */
#ifdef HAS_PRIORITY
